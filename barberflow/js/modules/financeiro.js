...
function rerenderFinanceiro() {
  ...
  if (financeiroState.isLoading) {
    root.innerHTML = `
      <div class="finance-loading-state">
        <div class="finance-loading-state__inner">
          <div class="finance-loading-state__spinner">⟳</div>
          <div class="finance-loading-state__text">Carregando financeiro...</div>
        </div>
      </div>`;
    return;
  }
...
const FINANCEIRO_CSS_ID = 'bbarberflow-financeiro-css';
const FINANCEIRO_CSS_HREF = '/css/modules/financeiro.css';

function ensureFinanceiroStylesheet() {
  if (typeof document === 'undefined') return;
  if (document.getElementById(FINANCEIRO_CSS_ID)) return;

  const link = document.createElement('link');
  link.id = FINANCEIRO_CSS_ID;
  link.rel = 'stylesheet';
  link.href = FINANCEIRO_CSS_HREF;
...
<section class="page-shell page--financeiro">
  ...
  <div id="finance-root">
    <div class="finance-loading-state finance-loading-state--initial">
      <div class="finance-loading-state__text">Iniciando financeiro...</div>
    </div>
  </div>

  <!-- Modal global -->
  <div id="finance-details-modal" class="modal-overlay" style="display:none;">
    <div class="modal finance-modal-shell">
